// TASK : We gonna perform Select class to handle static Drop down in this code
// This "SELECT" class only works for static dropdown list (TagName of select)
...
public class Test_09_StaticDropDown_lec51 {
